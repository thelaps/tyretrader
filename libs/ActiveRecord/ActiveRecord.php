...
class ActiveRecord{
    public function init($host, $user, $pass, $base, $arModelPath)
    {
        $cfg = ActiveRecord\Config::instance();
        $cfg->set_model_directory($arModelPath);
        $cfg->set_connections(array('development' => 'mysql://'.$user.':'.$pass.'@'.$host.'/'.$base));
    }
}
