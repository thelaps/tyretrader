...
<head>
   ...
   ================================================== -->
    ...
    <link rel="stylesheet" href="{$src}/stylesheets/jquery.selectbox.css">
    <link rel="stylesheet" href="{$src}/stylesheets/checkbox.css">

    <!-- JS
   ================================================== -->
    <script type="text/javascript" src="{$src}/js/jquery-1.7.1.min.js"></script>
    <script type="text/javascript" src="{$src}/js/jquery.selectbox-0.2.js"></script>
