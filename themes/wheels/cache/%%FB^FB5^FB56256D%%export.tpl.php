<?php /* Smarty version 2.6.26, created on 2014-06-22 01:18:38
                        ...
                        <input class="filter-sqlscopename" type="hidden" value="BT" name="filter[sqlscopename]">
                            ...
                            <div class="movableContainer">
                                <div class="movableHeading">
                                    <div class="item">
                                        ТОВАРЫ К-ВОМ НЕ МЕНЕЕ <input type="text" name="export[2][amount]">
                                    </div>
                                    <div class="item">
                                        КОДИРОВКА
...
/?view=api&load=opt" class="form form-export">
                        ...
                        <div class="movableContainer">
                            <div class="movableHeading">
                                <div class="item">
                                    ТОВАРЫ К-ВОМ НЕ МЕНЕЕ <input type="text" name="export[1][amount]">
                                </div>
                                <div class="item">
                                    КОДИРОВКА
                                    <ul class="opt-group select-export-type">
