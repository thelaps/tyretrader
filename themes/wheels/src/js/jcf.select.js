...
jcf.addModule({
    ...
    setupWrapper: function(){
        ...
        this.fakeElement.style.width = $(this.realElement).outerWidth() + 'px';
...
//		this.onControlReady(this);
    ...
    addEvents: function(){
        ...
        jcf.lib.event.add(this.realElement, 'refresh', this.rebuild, this);
    },
    ...
    buildDropdownScroll: function() {
        $(this.selectList).css({'max-height':'300px'});
    ...
    buildElement: function(obj){
        ...
        if(obj.tagName.toLowerCase() == 'option') {
            ...
            var visibility = ($(obj).css('display') != 'none')?'':' style="display: none;"';
            res += '<li rel="'+(this.optNum++)+'" class="'+(obj.className? obj.className : '')+' jcfcalc"'+visibility+'><a href="#">'+(obj.title? '<img src="'+obj.title+'" alt="" />' : '')+'<span>' + obj.innerHTML + '</span></a></li>';
    ...
    rebuild: function() {
        console.log('REBUILD BLEA');
        this.buildDropdown();
        this.refreshState();
        this.hideDropdown();
    },
    resetState: function() {
        if(this.realElement.options[0].title) {
            this.valueText.innerHTML = '<img src="'+this.realElement.options[0].title+'" alt="" />' + this.realElement.options[0].innerHTML;
        } else {
            this.valueText.innerHTML = this.realElement.options[0].innerHTML;
        }
